...
- cover the Taskcluster Chain of Trust
- first high level overview: what, why
...
- interested in Firefox/infra security
- interested in securing releases in the cloud
- looking for more info about the Chain of Trust
...
- is self-serve
- allows developers to make changes without being blocked on releng
- allows users to trigger arbitrary tasks to test things

It also presents a security challenge for release tasks.

---

Taskcluster scopes

- taskcluster's permission model
- not hack- or leak- proof
- if you have access to trigger a valid task of type X, you have access to trigger an arbitrary task of type X
...
We want to allow this flexibility in general, but restrict it for release tasks.
...
- we need to know the request is valid
